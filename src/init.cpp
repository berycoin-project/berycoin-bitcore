...
void Shutdown()
{
    ...
    if (pwalletMain)
    {
        StakeBerycoins(false, pwalletMain);
...
//////////////////////////////////////////////////////////////////////
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                if (fReindex) {
                    boost::filesystem::path stateDir = GetDataDir() / "stateBerycoin";
                ...
                boost::filesystem::path berycoinStateDir = GetDataDir() / "stateBerycoin";

                bool fStatus = boost::filesystem::exists(berycoinStateDir);
    ...
    if (!GetBoolArg("-staking", DEFAULT_STAKE))
        ...
        StakeBerycoins(true, pwalletMain);
#endif
    // ********************************************************* Step 12: finished
